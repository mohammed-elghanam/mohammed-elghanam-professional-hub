...
void runProfessionalHub() => runApp(const ProfessionalHubApp());
            ...
            sliver: SliverList.list(
              children: [
                ...
                _Action(
                  ...
                  'Executive Portfolio',
                  'Leadership positioning, innovation and consulting value',
                  () => push(context, const ExecutivePage()),
                ),
                _Action(
                  Icons.description_rounded,
                  'Career & Executive CV',
                  'Experience, education, certifications and professional record',
                  () => push(context, const CareerPage()),
                ),
                _Action(
                  Icons.memory_rounded,
                  'Skills & Expertise',
                  'Embedded, IoT, FPGA, industrial, power and safety-critical capabilities',
                  () => push(context, const SkillsPage()),
                ),
                _Action(
                  Icons.workspace_premium_rounded,
                  'Recognition & Patents',
                  'Granted patents and professional recognition summary',
                  () => push(context, const RecognitionPage()),
                ),
                _Action(
                  Icons.photo_library_rounded,
                  'Awards & Recognition Gallery',
                  'Kuwait awards, international recognition, smart utilities, telecommunications and railway-safety training',
                  () => push(context, const RecognitionGalleryPage()),
                ),
                _Action(
                  Icons.picture_as_pdf_rounded,
                  'Executive Document Center',
                  'Open, zoom, scroll, save or share the original PDF files',
                  () => push(context, const DocumentLibraryPage(showBack: true)),
                ),
              ],
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'R&D CTO · Flutter Executive Edition',
        ...
        children: [
          SizedBox(
            ...
            child: portrait == null
                ? Container(
                    color: C.panel2,
                    child: const Center(child: _Seal(120, 44)),
                  )
                : Image.memory(
                    portrait!,
                    fit: BoxFit.cover,
          ...
          const Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 7),
                Text(
                  'Embedded & IoT Product Development · Smart Metering · LPWAN · FPGA · Industrial Automation · Safety-Critical Systems',
                  style: TextStyle(
                    color: C.muted,
                    fontSize: 13,
                    height: 1.45,
...
class _Metric extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: C.cyan.withValues(alpha: .18)),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
...
class _Action extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Card(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: C.cyan.withValues(alpha: .18)),
        ),
        child: InkWell(
          onTap: onTap,
          borderRadius: BorderRadius.circular(20),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: C.gold.withValues(alpha: .72)),
                  ),
                  child: Icon(icon, color: C.gold, size: 27),
                ),
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'Open the original PDFs inside the app, zoom and scroll, then save a copy or share it.',
...
class _DocumentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Card(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(20),
          side: BorderSide(color: C.gold.withValues(alpha: .36)),
        ),
        child: InkWell(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: C.gold.withValues(alpha: .7)),
                  ),
                  child: const Icon(
                    Icons.picture_as_pdf_rounded,
                    color: C.gold,
  ...
  Future<void> _save(Uint8List bytes) async {
    ...
    try {
      final result = await PublicFileSaver().saveBytes(
        ...
        subDir: 'Mohammed Elghanam Professional Hub',
      );
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            result == null
                ? 'Save was cancelled or could not be completed.'
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Unable to save PDF: $e')),
      );
    } finally {
          ...
          appBar: AppBar(
            ...
            actions: [
              if (snap.hasData)
                IconButton(
                  tooltip: 'Save PDF',
                  onPressed: saving ? null : () => _save(snap.data!),
                  icon: saving
                      ? const SizedBox(
                          width: 20,
                          height: 20,
                      ...
                      : const Icon(Icons.download_rounded, color: C.gold),
                ),
              if (snap.hasData)
                IconButton(
                  tooltip: 'Share PDF',
  ...
  Widget build(BuildContext context) => _ListScreen(
        ...
        children: [
          for (var i = 0; i < p.length; i++)
            _Info(
              '${(i + 1).toString().padLeft(2, '0')} · ${p[i].$1}',
              p[i].$2,
...
class RecognitionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _ListScreen(
        ...
        children: [
          const _Info('5 Granted Patents', 'Five granted patents associated with embedded systems, IoT and smart metering innovation.', Icons.verified_rounded),
          const _Info('International Recognition · IIFME Kuwait', 'Recognition associated with “Upgrading of Traditional Meters into Smart Meters” at the International Invention Fair of the Middle East, Kuwait, 2018.', Icons.emoji_events_rounded),
          const _Info('Medical R&D Certification Status', 'Ventilator and oxygen concentrator systems received calibration and safety certification from Cairo University Medical Calibration and Safety Center. Egyptian Drug Authority licensing procedures remain in progress.', Icons.medical_services_rounded),
          _GalleryLauncher(onTap: () => push(context, const RecognitionGalleryPage())),
        ],
      );
}
...
class _GalleryLauncher extends StatelessWidget {
  final VoidCallback onTap;
  const _GalleryLauncher({required this.onTap});
  ...
  Widget build(BuildContext context) => Card(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: C.gold.withValues(alpha: .55)),
        ),
        child: InkWell(
          onTap: onTap,
          borderRadius: BorderRadius.circular(18),
          child: const Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.photo_library_rounded, color: C.gold, size: 28),
                SizedBox(width: 13),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Open Awards & Recognition Gallery', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900)),
                      SizedBox(height: 4),
                      Text('Browse photos, certificates and event highlights by category.', style: TextStyle(color: C.muted, height: 1.4)),
                    ],
                  ),
                ),
                Icon(Icons.chevron_right_rounded, color: C.cyan),
              ],
            ),
          ),
        ),
...
enum GalleryCategory { all, kuwait, innovation, international, telecom, certification }
...
class GalleryEntry {
  ...
  final Set<GalleryCategory> categories;
  final bool contain;
...
const _galleryBase = 'https://mohammed-elghanam-professional-hub.vercel.app';

const galleryEntries = <GalleryEntry>[
  GalleryEntry(
    image: '$_galleryBase/gallery_01_kuwait_invention_award.jpg',
    tag: 'KUWAIT · INTERNATIONAL INVENTION FAIR',
    title: 'Second-Place Innovation Recognition',
    description: 'Second-place recognition at the Kuwait International Invention Fair for smart-metering innovation, presented within the international invention community in Kuwait.',
    categories: {GalleryCategory.kuwait, GalleryCategory.international},
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_02_kuwait_press_coverage.jpg',
    tag: 'MEDIA · KUWAIT',
    title: 'International Fair Press Coverage',
    description: 'Press coverage from Kuwait during the 10th International Invention Fair in the Middle East, documenting the event and regional innovation activity.',
    categories: {GalleryCategory.kuwait, GalleryCategory.international},
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_03_smart_utilities_showcase.png',
    tag: 'SMART UTILITIES · PRODUCT SHOWCASE',
    title: 'Smart Metering & Utilities Exhibition',
    description: 'Professional showcase of smart electricity, water and gas metering platforms with connected monitoring and utility-management solutions.',
    categories: {GalleryCategory.innovation},
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_04_portugal_scientific_merit.jpeg',
    tag: 'PORTUGAL · SCIENTIFIC MERIT',
    title: 'International Scientific Recognition',
    description: 'Official recognition for special scientific merit and international cooperation from Portuguese invention and research organizations for “Upgrading of Traditional Meters into Smart Meters.”',
    categories: {GalleryCategory.international, GalleryCategory.innovation},
    contain: true,
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_05_tuv_cenelec_rail_safety.jpg',
    tag: 'GERMANY · TÜV SÜD RAIL',
    title: 'CENELEC Railway Safety Training',
    description: 'TÜV SÜD Rail training in Braunschweig, Germany, covering CENELEC railway standards, functional and technical safety, RAM and the safety lifecycle.',
    categories: {GalleryCategory.certification},
    contain: true,
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_06_itc_egypt_2027_group.jpeg',
    tag: 'TELECOMMUNICATIONS · EGYPTIAN MILITARY ACADEMY',
    title: 'International Telecommunications Conference',
    description: 'Conference participation and professional networking focused on communication technologies, intelligent networks, cybersecurity, satellite systems and the future of telecommunications.',
    categories: {GalleryCategory.telecom},
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_07_military_academy_event.jpeg',
    tag: 'EGYPTIAN MILITARY ACADEMY',
    title: 'Professional & Institutional Engagement',
    description: 'Professional participation with academic, engineering and institutional representatives at the Egyptian Military Academy.',
    categories: {GalleryCategory.telecom, GalleryCategory.international},
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_08_itc_egypt_2027_group_2.jpeg',
    tag: 'TELECOMMUNICATIONS · PROFESSIONAL NETWORKING',
    title: 'Telecommunications Community Participation',
    description: 'Professional engagement with specialists and institutional representatives around emerging communications, intelligent networks and secure digital infrastructure.',
    categories: {GalleryCategory.telecom},
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_09_kuwait_official_recognition.jpg',
    tag: 'KUWAIT · OFFICIAL RECOGNITION',
    title: 'Recognition by Event Officials',
    description: 'Professional recognition and engagement with Kuwaiti officials and senior event representatives during international innovation activities.',
    categories: {GalleryCategory.kuwait, GalleryCategory.international},
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_10_international_event_portrait.jpg',
    tag: 'INTERNATIONAL EVENTS',
    title: 'Cross-Border Professional Engagement',
    description: 'Participation in international professional and innovation events, supporting technical exchange, collaboration and engineering visibility.',
    categories: {GalleryCategory.international},
  ),
  GalleryEntry(
    image: '$_galleryBase/gallery_11_kuwait_official_engagement.jpg',
    tag: 'KUWAIT · PROFESSIONAL ENGAGEMENT',
    title: 'Innovation Community Networking',
    description: 'Professional engagement with regional officials and innovation-community representatives during Kuwait-based international events.',
    categories: {GalleryCategory.kuwait, GalleryCategory.international},
  ),
];

class RecognitionGalleryPage extends StatefulWidget {
  const RecognitionGalleryPage({super.key});

  @override
  State<RecognitionGalleryPage> createState() => _RecognitionGalleryPageState();
}

class _RecognitionGalleryPageState extends State<RecognitionGalleryPage> {
  GalleryCategory selected = GalleryCategory.all;

  String label(GalleryCategory c) => switch (c) {
        GalleryCategory.all => 'All',
        GalleryCategory.kuwait => 'Kuwait Awards',
        GalleryCategory.innovation => 'Smart Utilities',
        GalleryCategory.international => 'International',
        GalleryCategory.telecom => 'Telecommunications',
        GalleryCategory.certification => 'Certification & Rail Safety',
      };

  @override
  Widget build(BuildContext context) {
    final entries = selected == GalleryCategory.all
        ? galleryEntries
        : galleryEntries.where((e) => e.categories.contains(selected)).toList();

    return Scaffold(
      appBar: AppBar(title: const Text('Awards & Recognition Gallery')),
      body: SafeArea(
        child: ListView(
          padding: const EdgeInsets.fromLTRB(14, 18, 14, 30),
          children: [
            const _Kicker('AWARDS · EVENTS · CERTIFICATIONS'),
            const SizedBox(height: 8),
            const Text(
              'Professional Recognition Gallery',
              style: TextStyle(
                fontFamily: 'serif',
                color: C.gold2,
                fontSize: 32,
            ...
            const SizedBox(height: 8),
            const Text(
              'A visual record of innovation exhibitions, international recognition, smart-utilities showcases, telecommunications events and railway-safety training.',
              style: TextStyle(color: C.muted, height: 1.5),
            ),
            const SizedBox(height: 16),
                    ...
                    Padding(
                      ...
                      child: ChoiceChip(
                        ...
                        labelStyle: TextStyle(
                          color: selected == c ? C.navy : C.text,
                          fontWeight: FontWeight.w800,
                        ),
                      ),
                    ),
            ...
            const SizedBox(height: 14),
            for (final entry in entries) _GalleryCard(entry),
          ],
        ),
      ),
    );
...
class _GalleryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Card(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(20),
          side: BorderSide(color: C.cyan.withValues(alpha: .2)),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            InkWell(
              ...
              child: AspectRatio(
                aspectRatio: 4 / 3,
                child: Container(
                  color: entry.contain ? const Color(0xFFE8E8E8) : C.navy2,
                  child: Image.network(
                    entry.image,
                    fit: entry.contain ? BoxFit.contain : BoxFit.cover,
                    ...
                    errorBuilder: (_, __, ___) => const Center(
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(Icons.cloud_off_rounded, color: C.gold, size: 42),
                          SizedBox(height: 8),
                          Text('Image requires an internet connection', style: TextStyle(color: C.muted)),
                        ],
                      ),
                    ),
                  ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    body,
                    style: const TextStyle(color: C.muted, height: 1.48),
                  ),
                ],
              ),
            ),
...
class ContactPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _ListScreen(
        ...
        intro: 'External actions are limited to genuine communication and professional links.',
        children: [
          ...
          _Contact(Icons.photo_library_rounded, 'Recognition Gallery', 'Awards, events and certifications', () => push(context, const RecognitionGalleryPage())),
        ],
      );
}
        ...
        child: FilledButton.tonal(
          ...
          child: Row(
            children: [
              ...
              const Icon(Icons.chevron_right_rounded, color: C.cyan, size: 18),
            ],
          ),
        ),
      );
