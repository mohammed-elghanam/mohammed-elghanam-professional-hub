...
pw.PageTheme _theme() => const pw.PageTheme(
      pageFormat: PdfPageFormat.a4,
      margin: pw.EdgeInsets.zero,
    );

pw.Widget _background(List<pw.Widget> children) => pw.Container(
      color: _navy2,
  ...
  return pw.Container(
    ...
    decoration: pw.BoxDecoration(
      ...
      border: pw.Border.all(
        color: const PdfColor.fromInt(0xFF24506A),
        width: .7,
      ),
    ),
    child: pw.Column(
      ...
      build: (_) => [
        _background([
          ...
          _section(
            ...
            'Transforms technical ideas into practical, scalable, market-aligned engineering solutions by combining technology strategy, system architecture, embedded hardware, firmware, FPGA, validation, and cross-functional leadership.',
          ),
          _section(
            'Core Expertise',
...
Future<Uint8List> buildProjectPortfolioPdf() async {
  ...
  final projects = <(String, String)>[
    ...
    ('Medical Device R&D Systems', 'Ventilator and oxygen concentrator control-system R&D with calibration and safety certification from Cairo University Medical Calibration and Safety Center; Egyptian Drug Authority licensing procedures remain in progress.'),
